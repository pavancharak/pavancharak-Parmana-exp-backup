...
## Connector integration and signal/intent binding (61-62)

| # | Name | Demonstrates |
|---|---|---|
| 61 | Razorpay Refund | A real connector fetch-verifying payment state before evaluating policy, then executing through the signed-authorization / Execution Gateway pipeline, unmodified — approval, denial, replay, and tamper rejection |
