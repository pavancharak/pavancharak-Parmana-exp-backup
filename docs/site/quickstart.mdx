...
<Info>
**[AVAILABLE]**, every command below was re-run against a live local server on 2026-07-21
(commit `5c688b4`), including `python/examples/quickstart/run.py` itself.
</Info>
...
Captured from an actual run, 2026-07-21 (IDs and hashes differ on every run):

```
Trust Record Hash: 3f0f63f879b55b83fa22f19f59348336899114e5315b40ad78dfa3849cfe63cd
```
