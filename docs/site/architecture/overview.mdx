...
[Content Binding & TOCTOU](/concepts/content-binding-toctou), which already reflects this
same correction (checked directly this pass, not assumed).
</Warning>
...
server is not that minimal case: it always builds the full gateway, as shown above. See
[Content Binding & TOCTOU](/concepts/content-binding-toctou) for the mechanism itself — it is
current, not the older gateway-optional description this page's own history once implied.
