...
| 7. Execution Trust Record | Assembles the immutable record: transaction, executions, overrides, verifications, receipts, canonical hash, signature | [AVAILABLE] | `BusinessTrustRecordBuilder`, CLAIMS.md 2.5 |
