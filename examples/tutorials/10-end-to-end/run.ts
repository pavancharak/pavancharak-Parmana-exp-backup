...
// --------------------------------------------------
// RECEIPT (NEW ARCHITECTURE - NO ReceiptService)
// --------------------------------------------------
...
console.log("========================================");
console.log(" Parmana Tutorial 10 - End-to-End");
console.log("========================================");

console.log();

console.log("Business Transaction Executed");
...
console.log("========================================");
console.log(" END-TO-END COMPLETED SUCCESSFULLY");
console.log("========================================");